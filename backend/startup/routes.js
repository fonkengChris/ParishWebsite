...
import apostolateRoutes from '../routes/apostolates.js';
import sacramentRoutes from '../routes/sacraments.js';
import parishServiceRoutes from '../routes/parishServices.js';
...
export const setupRoutes = (app) => {
  ...
  app.use('/api/parish-services', parishServiceRoutes);
